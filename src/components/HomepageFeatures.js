...
const FeatureList = [
  {
    ...
    description: (
      ...
      <br></br><br></br> We are working to bring permissionless decentralized publishing to Web3.  
  ...
  },
  {
    ...
    description: (
      ...
      <br></br><br></br> $PAGE grants govenance weight, access to DAO member perks, and can be used to buy custom content on our <a href = "https://app.dework.xyz/pagedao-web3-writers"> Community Dework Board. </a> 
  ...
  },
  {
    ...
    description: (
      ...
      <br></br><br></br> We work collectively to put writers and developers in touch with each other about what really matters, and then we build together.
